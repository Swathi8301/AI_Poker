...
# Agent
POKER_CLIENT_NAME = 'Poker Player Agent#17'
CURRENT_HAND = []
hand=[]
cards = ""
card_list = []
...
numbers = []
rank=""
Hands={1:"Straight Flush",2:"Four of a Kind",
3:"Full House", 4:"Flush", 5:"Straight",
6:"Three of a Kind",7: "Two Pair",8: "One Pair",
9: "High Cards",0: "No Hand"}
